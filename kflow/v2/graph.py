"""Validated graph projection for KFlow v2 derivations."""
...
from kflow.v2.models import Derivation, KnowledgeNode
...
class GraphValidationError(ValueError):
    """Raised when nodes and derivations do not form a valid KFlow v2 graph."""
